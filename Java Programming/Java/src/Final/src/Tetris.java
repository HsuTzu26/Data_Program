...
class GameWindow extends JFrame
{
    ...
    class TimerHandler implements ActionListener
    {
        public void actionPerformed(ActionEvent e) {
         //   int ss =  JOptionPane.showConfirmDialog(GameWindow.this, String.format("为%d", score),"Choose",JOptionPane.YES_NO_OPTION);
            if (!moveDown()) {
                fixBox();
                clearLine();
                timer.stop();
                String[] options={"OK", "再玩一次"};
                Object[] option = {"OK", "再玩一次"};



                if (gameOver())
                  JOptionPane.showConfirmDialog(GameWindow.this, String.format("游戏结束，你的得分为%d", score),"Choose",JOptionPane.YES_NO_OPTION);
