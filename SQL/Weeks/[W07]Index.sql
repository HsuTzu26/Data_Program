...
-- 建立單一的索引鍵
CREATE INDEX MyIndex_1  ON Table_3 (c1) 
CREATE INDEX MyIndex_2  ON Table_3 (c2, c3)        
...
-- 建立單一的索引鍵 & 非叢集所引鍵
CREATE UNIQUE NONCLUSTERED INDEX index_3 ON TABLE_4 (ProductName) INCLUDE (price)
